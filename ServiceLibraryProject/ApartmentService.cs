...
namespace ServiceLibraryProject
{
    ...
    public class ApartmentService : IService<Apartment>
    {
        ...
        /// <summary>
        /// Obtiene todos los apartamentos de un piso específico.
        /// </summary>
        /// <param name="floorId">Identificador del piso.</param>
        /// <returns>Una colección de apartamentos del piso especificado.</returns>
        ...
        /// <returns>Una colección de apartamentos del edificio especificado.</returns>
