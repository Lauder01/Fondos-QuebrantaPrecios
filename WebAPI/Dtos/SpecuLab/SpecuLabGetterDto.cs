...
/// <summary>
/// Este dto está para que speculab acceda a un edificio en concreto.
/// </summary> 
...
namespace WebAPI.Dtos.SpecuLab
{
    public class SpecuLabGetterDto
    {
        ...
        [StringLength(255, MinimumLength = 0, ErrorMessage = "ERR003: El campo Nombre de Edificio debe tener entre 0 y 255 caracteres")]
        public required string BuildingName { get; set; } = string.Empty;

        [Required(ErrorMessage = "ERR004: El campo Dirección es obligatorio")]
        public required string ConstructedAddress { get; set; }

        [Required(ErrorMessage = "ERR005: El campo Distrito es obligatorio")]
        [StringLength(255, MinimumLength = 1, ErrorMessage = "ERR006: El campo Distrito debe tener entre 1 y 255 caracteres")]
        ...
        [Required(ErrorMessage = "ERR011: El campo Código Postal es obligatorio")]
