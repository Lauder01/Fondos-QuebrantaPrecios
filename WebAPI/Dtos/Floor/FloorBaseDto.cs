...
namespace WebAPI.Dtos.Floor
{
    public class FloorBaseDto : IValidatableObject
    {
        ...
        [Required(ErrorMessage = "ERR003: El campo Identificador de Edificio es obligatorio")]
        [StringLength(36, MinimumLength = 36, ErrorMessage = "ERR004: El campo Identificador de Edificio debe tener exactamente 36 caracteres")]
